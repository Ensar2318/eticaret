...
(5, 'Deniz Bank', '428561029965151518151512', 'Ensar Kahraman', '1'),
(6, 'iş bankası', '451515184874948949819823', 'Ensar kahraman Mücahit', '1'),
(7, 'Garanti', '264857000100541588478820', 'Ensar Kahraman', '1'),
(10, 'Yapı Kredi', '000400054841005185185151', 'Ensar Kahraman', '1');
...
CREATE TABLE `kategori` (
  ...
  `kategori_durum` enum('0','1') CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='katago';
...
(1, 'ayakkabılar ve yenilik', 0, 'ayakkabilar-ve-yenilik', 3, '1'),
(2, 'gömlekler', 0, 'gomlekler', 0, '1'),
(3, 't-shirtler', 0, 't-shirtler', 2, '1'),
(8, 'şapkalar', 0, 'sapkalar', 1, '1'),
(9, 'allah kategorisi', 0, 'allah-kategorisi', 10, '1'),
(10, 'cihan', 0, 'cihan', 8, '1');
...
(12, '2022-05-22 18:32:13', '', '42856105887', '', 'test@gmail.com', '5349190288', '8d014dee20a374dc7ad97e4d9809829e', 'Test Geralt', '42856105887', 'istanbul', 'fatih', 'developer', '1', 1),
(13, '2022-05-24 09:26:44', '', '', '', 'mehmet@gmail.com', '', 'b2d4bc55b5be8adc17252b3c43931ff0', 'mehmet yüksel', '', '', '', '', '1', 1),
(14, '2022-05-24 09:35:27', '', '', '', 'faruk@gmail.com', '', 'de10bce55c9aa126feb0ab0e6bf403b2', 'faruk gülllüoğglu', '', '', '', '', '1', 1),
(15, '2022-05-27 12:39:41', '', '', '', 'eyub@gmail.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'eyüb eyyübi', '', '', '', '', '1', 1),
(16, '2022-05-28 09:47:41', '', '', '', 'melih@gmail.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'melih gökce', '', '', '', '', '1', 1);
...
(18, '', 'detail', '<p>detail mahmudo</p>', '', 6, '1', 'detail'),
(19, '', 'kategoriler', '', 'kategoriler', 0, '1', 'kategoriler');
...
CREATE TABLE `slider` (
  ...
  `slider_durum` enum('1','0') CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
(7, 12, 14, 'Küfür yok beyler', '2022-05-27 09:25:56', '1'),
(9, 12, 13, 'mahmudo fuckinq Adio\r\n', '2022-05-27 10:09:55', '1'),
(10, 12, 14, 'Kırım Kongo Kanamalı Sikik Eyyübi', '2022-05-27 10:50:40', '1'),
(11, 12, 11, 'Sikerler adımı he', '2022-05-28 06:46:44', '1'),
(15, 16, 14, 'yarramı yparsın', '2022-05-28 13:56:24', '1');
...
--
ALTER TABLE `banka`
  MODIFY `banka_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
