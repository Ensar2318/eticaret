...
--
-- Anamakine: localhost
-- Üretim Zamanı: 18 May 2022, 14:42:12
...
CREATE TABLE `ayar` (
  ...
  `ayar_smtpuser` varchar(50) COLLATE utf32_turkish_ci NOT NULL,
...
(0, '', 'Deku E-Ticaret', 'Deku First E-Ticaret Scriptim', 'eticaret, shopping, php, learning, student php', 'Deku', '0534 919 02 88', '0534 909 02 85', '0632 12 12', 'info@deko.com.tr', 'fatih', 'istanbul', 'yavuzselim mahallesi dönemec sokak no 1 daire 10', '7 x 24 acik eticaret script', 'Maps_api', 'Analystick_api', 'Zopim_api', 'www.facebook.com.tr', 'www.twitter.com', 'www.google.com', 'www.youtube.com.tr', 'mail.alanadiniz.com', 'smtpuserss', 'password', ' 587', '1');
...
CREATE TABLE `hakkimizda` (
  ...
  `hakkimizda_baslik` varchar(250) COLLATE utf32_turkish_ci NOT NULL,
  `hakkimizda_icerik` text COLLATE utf32_turkish_ci NOT NULL,
  `hakkimizda_video` varchar(50) COLLATE utf32_turkish_ci NOT NULL,
  `hakkimizda_vizyon` varchar(500) COLLATE utf32_turkish_ci NOT NULL,
  `hakkimizda_misyon` varchar(500) COLLATE utf32_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_turkish_ci;
