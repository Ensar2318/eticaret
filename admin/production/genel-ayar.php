      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../nesting/islem.php" method="POST" enctype="multipart/form-data" id="uploadphoto" data-parsley-validate class="form-horizontal form-label-left">

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Yüklü Logo <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php if (!empty($ayarcek['ayar_logo'])) { ?>
              ...
              <input style="display: none;" value="<?php echo $ayarcek['ayar_logo'] ?>" name="eski_logo" type="text" id="first-name" class="form-control col-md-7 col-xs-12">
